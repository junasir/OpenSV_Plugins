...
class MediapipeGestureUi(JuDialog):

    def __init__(self, parent=None, default_parm=None, combox_list=None, log=None, *args, **kwargs):
        super(MediapipeGestureUi, self).__init__(parent, *args, **kwargs)
        self.setWindowTitle("mediapipe手势检测")
        self.ui_log = log
    ...
    def _init_ui(self):
        ...
        label_thresh = QLabel(self, text="手的最大数量:")
...
class CalcGraphicsNode(QDMGraphicsNode):
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "Mediapipe", "index": 0},
                                 "operation_file": "JuMediapipeGesture", "operation_func": "mediapipe_gesture_det",
    ...
    def double_click_ui_show(self):
        ...
        parameters_win = MediapipeGestureUi(default_parm=self.default_parm, combox_list=self.combox_list,
...
class MediapieGestureContent(QDMNodeContentWidget):
    def initUI(self):
        pass
...
class JuIpMediapipeGesture(Node):
    icon = "icons/in.png"
    op_code = "Mediapipe_Gesture"
    op_title = "Mediapipe手势检测"
    content_label_objname = "node_mediapipe_gesture"
    version = "v0.1"
    ...
    def initInnerClasses(self):
        self.content = MediapieGestureContent(self)
...
if __name__ == "__main__":
    ...
    window = MediapipeGestureUi(default_parm=default_parm, combox_list=["img"])
    window.show()
    exit(app.exec_())
    pass
