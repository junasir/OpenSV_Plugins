...
class ImgShowUi(JuDialog):
    ...
    def __init__(self, parent=None, default_parm=None, combox_list=None, log=None, *args, **kwargs):
        ...
        self.setWindowTitle("Seetaface人脸检测")
        self.ui_log = log
    ...
    def _init_ui(self):
        ...
        label_thresh = QLabel(self, text="最小人脸像素:")
        self.label_thresh = QLineEdit(self)
        label_maxval = QLabel(self, text="阈值:")
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuSeetafaceDetection", "operation_func": "opencv_seetaface_detection",
...
class JuIpSeetafaceDetection(Node):
    icon = ""
    op_code = "CalcNode_Seetaface_detection"
    op_title = "Seetaface人脸检测"
    content_label_objname = "calc_node_face_Seetaface_detection"
    version = "v0.1"
