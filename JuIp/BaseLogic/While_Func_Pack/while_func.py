...
class ImgShowUi(JuDialog):
    ...
    def _init_ui(self):
        ...
        self.label_input_variable.setEnabled(False)
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "BaseLogic", "index": 0},
                                 "operation_file": "JuBaseFunc", "operation_func": "while_info",
...
class JuIpWhileFunc(Node):
    icon = "icons/in.png"
    op_code = "CalcNode_While_Func"
    op_title = "while"
    content_label_objname = "calc_node_img_while_func"
    version = "v0.1"
