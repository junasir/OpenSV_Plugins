    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvHough", "operation_func": "opencv_sobel_func",
...
class JuIpImgSobel(Node):
    icon = ""
    op_code = "CalcNode_ImgSobel"
    op_title = "Sobel边缘检测"
    content_label_objname = "calc_node_img_sobel"
    version = "v0.1"
