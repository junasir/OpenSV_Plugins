    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvHough", "operation_func": "opencv_line_func",
...
class JuIpImgHoughLines(Node):
    icon = ""
    op_code = "CalcNode_ImgHoughLines"
    op_title = "霍夫直线检测"
    content_label_objname = "calc_node_img_hough_lines"
    version = "v0.1"

    def __init__(self, scene, inputs=[(1, "input_img")], outputs=[(2, "output_coordinate")]):
