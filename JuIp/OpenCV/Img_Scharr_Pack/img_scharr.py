...
class ImgShowUi(JuDialog):
    ...
    def _init_ui(self):
        ...
        label_2 = QLabel(self, text="dx:")
        self.label_2 = QLineEdit(self)
        label_3 = QLabel(self, text="dy:")
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvHough", "operation_func": "opencv_scharr_func",
...
class JuIpImgScharr(Node):
    icon = ""
    op_code = "CalcNode_ImgScharr"
    op_title = "Scharr边缘检测"
    content_label_objname = "calc_node_img_scharr"
    version = "v0.1"
