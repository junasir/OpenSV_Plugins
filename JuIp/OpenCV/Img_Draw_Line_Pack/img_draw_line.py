    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvHough", "operation_func": "opencv_draw_line_func",
...
class JuIpImgDrawLine(Node):
    icon = ""
    op_code = "CalcNode_ImgDrawLine"
    op_title = "画直线"
    content_label_objname = "calc_node_img_draw_line"
    version = "v0.1"
