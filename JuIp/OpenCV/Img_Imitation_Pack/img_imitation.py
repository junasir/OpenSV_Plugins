...
class ImgShowUi(JuDialog):
    ...
    def _init_ui(self):
        ...
        label_1 = QLabel(self, text="矩阵11:")
        self.label_1 = QLineEdit(self)
        label_2 = QLabel(self, text="矩阵12:")
        self.label_2 = QLineEdit(self)
        label_3 = QLabel(self, text="矩阵13:")
        self.label_3 = QLineEdit(self)
        label_4 = QLabel(self, text="矩阵21:")
        self.label_4 = QLineEdit(self)
        label_5 = QLabel(self, text="矩阵22:")
        self.label_5 = QLineEdit(self)
        label_6 = QLabel(self, text="矩阵23:")
        self.label_6 = QLineEdit(self)
        ...
        self._grid.addWidget(label_4, 4, 0)
        self._grid.addWidget(self.label_4, 4, 1)
        self._grid.addWidget(label_5, 5, 0)
        self._grid.addWidget(self.label_5, 5, 1)
        self._grid.addWidget(label_6, 6, 0)
        self._grid.addWidget(self.label_6, 6, 1)
    ...
    def generate_parameters(self):
        ...
        if self.label_4.text() != "":
            value_list.append(self.label_4.text())
        if self.label_5.text() != "":
            value_list.append(self.label_5.text())
        if self.label_6.text() != "":
            value_list.append(self.label_6.text())
    ...
    def _parameters_show(self):
        if len(self._default_parm["value"]) == 7:
            ...
            self.label_4.setText(self._default_parm["value"][4])
            self.label_5.setText(self._default_parm["value"][5])
            self.label_6.setText(self._default_parm["value"][6])
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvTurnOver", "operation_func": "opencv_imitation_func",
...
class JuIpImgImitation(Node):
    icon = ""
    op_code = "CalcNode_ImgImitation"
    op_title = "图像仿射变换"
    content_label_objname = "calc_node_img_imitation"
    version = "v0.1"
