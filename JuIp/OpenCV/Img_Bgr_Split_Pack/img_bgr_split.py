...
class CalcGraphicsNode(QDMGraphicsNode):
    ...
    def double_click_ui_show(self):
        ...
        parameters_win = ImgRgbSplitUi(default_parm=self.default_parm, combox_list=self.combox_list, log=self.user_logger)
...
class JuIpImgBgrSplit(Node):
    ...
    def __init__(self, scene, inputs=[(1, "input")], outputs=[(3, "output")]):
