    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvBlur", "operation_func": "opencv_blur_func",
...
class JuIpImgJunzhiBlur(Node):
    icon = ""
    op_code = "CalcNode_ImgBlur"
    op_title = "图像均值滤波"
    content_label_objname = "calc_node_img_blur"
    version = "v0.1"
