...
class ImgShowUi(JuDialog):
    ...
    def _init_ui(self):
        label_input_variable = QLabel(self, text="输入坐标变量:")
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvHough", "operation_func": "opencv_draw_rectangle_func",
...
class JuIpImgDrawRectangle(Node):
    icon = ""
    op_code = "CalcNode_ImgDrawRectangle"
    op_title = "画矩形"
