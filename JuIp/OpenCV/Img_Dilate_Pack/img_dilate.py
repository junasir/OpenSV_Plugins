    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvBlur", "operation_func": "opencv_dilate_func",
...
class JuIpImgDilate(Node):
    icon = ""
    op_code = "CalcNode_ImgDilate"
    op_title = "图像膨胀"
    content_label_objname = "calc_node_img_dilate"
    version = "v0.1"
