    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "BaseLogic", "index": 0},
                                 "operation_file": "JuBaseFunc", "operation_func": "base_print",
...
class JuIpPrintFunc(Node):
    icon = "icons/in.png"
    op_code = "CalcNode_PrintFunc"
    op_title = "print"
    content_label_objname = "calc_node_img_print_func"
    version = "v0.1"

    def __init__(self, scene, inputs=[(1, "print")], outputs=[(1, "connect")]):
