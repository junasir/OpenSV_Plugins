...
class ImgTurnOverUi(JuDialog):
    ...
    def _init_ui(self):
        ...
        label_thresh = QLabel(self, text="翻转方向:")
...
class CalcGraphicsNode(QDMGraphicsNode):
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvTurnOver", "operation_func": "opencv_turn_over_func",
    ...
    def double_click_ui_show(self):
        ...
        parameters_win = ImgTurnOverUi(default_parm=self.default_parm, combox_list=self.combox_list, log=self.user_logger)
...
class JuIpImgTurnOver(Node):
    icon = ""
    op_code = "CalcNode_ImgTurnOver"
    op_title = "图像翻转"
    content_label_objname = "calc_node_img_turn_over"
    version = "v0.1"
...
if __name__ == "__main__":
    ...
    window = ImgTurnOverUi(default_parm=default_parm, combox_list=["img"])
    window.show()
    exit(app.exec_())
