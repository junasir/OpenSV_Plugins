...
class ImgBlurUi(JuDialog):
    ...
    def _init_ui(self):
        ...
        label_2 = QLabel(self, text="normalize:")
        ...
        self._grid.addWidget(label_thresh, 2, 0)
        self._grid.addWidget(self.label_thresh, 2, 1)
    ...
    def _parameters_show(self):
        if len(self._default_parm["value"]) == 2:
            ...
            self.label_thresh.setText(self._default_parm["value"][2])
...
class CalcGraphicsNode(QDMGraphicsNode):
    ...
    def __init__(self, node: 'Node'):
        ...
        if self.default_parm is None:
            self.default_parm = {"object": {"type": "OpenCV", "index": 0},
                                 "operation_file": "JuOpencvBlur", "operation_func": "opencv_box_filter_func",
    ...
    def double_click_ui_show(self):
        ...
        parameters_win = ImgBlurUi(default_parm=self.default_parm, combox_list=self.combox_list, log=self.user_logger)
...
class JuIpImgBoxFilter(Node):
    icon = ""
    op_code = "CalcNode_ImgBoxFilter"
    op_title = "图像方框滤波"
    content_label_objname = "calc_node_img_box_filter"
    version = "v0.1"
